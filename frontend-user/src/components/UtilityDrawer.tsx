    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed right-4 top-[80px] bottom-4 z-[50] flex flex-row overflow-hidden rounded-2xl border border-slate-200/60 dark:border-slate-800/80 shadow-2xl pointer-events-auto bg-slate-50 dark:bg-[#0b0e14]/90 backdrop-blur-md text-left"
        >
